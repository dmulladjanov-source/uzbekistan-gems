      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden lg:flex items-center space-x-1">
            ...
            <div className="ml-3 flex items-center gap-1 bg-secondary/80 rounded-full px-3 py-1.5 border border-border">
              <Phone className="h-4 w-4 text-primary" />
              <span className="text-sm font-medium text-foreground hidden xl:inline">{PHONE_DISPLAY}</span>
        ...
        {isOpen && (
          ...
          >
            <nav className="container mx-auto px-4 py-4 flex flex-col space-y-2">
              ...
              <div className="mt-4 flex items-center justify-center gap-3 p-3 bg-secondary rounded-lg">
