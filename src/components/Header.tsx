...
const PHONE_DISPLAY = "+998 99 015 21 10";
        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden lg:flex items-center space-x-1">
            ...
            <a
              ...
              className="ml-3 flex items-center gap-2 bg-primary/10 hover:bg-primary/20 rounded-full px-4 py-2 border border-primary/20 transition-colors"
            >
              <Phone className="h-4 w-4 text-primary" />
              <span className="text-sm font-semibold text-primary">{PHONE_DISPLAY}</span>
            </a>
